  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shop as @shop" do
        ...
        post :create, {:shop => { "link_id" => "invalid value" }}, valid_session
        assigns(:shop).should be_a_new(Shop)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shop" do
        ...
        Shop.any_instance.should_receive(:update_attributes).with({ "link_id" => "1" })
        put :update, {:id => shop.to_param, :shop => { "link_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the shop as @shop" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Shop.any_instance.stub(:save).and_return(false)
        put :update, {:id => shop.to_param, :shop => { "link_id" => "invalid value" }}, valid_session
        assigns(:shop).should eq(shop)
      end
